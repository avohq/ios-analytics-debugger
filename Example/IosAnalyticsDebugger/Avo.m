...
+ (void)invoke:(NSString *)eventId hash:(NSString *)hash messages:(NSArray *)messages {
  ...
  if (samplingRate > 0) {
    if (drand48() < samplingRate) {
      NSLog(@"invoke DXS9I1Jxjwyw8JOndEeK master 0cd8DLUxoxnhXaqRxL6O DQ9ku0SjZ");
      NSDictionary *payload = @{
        @"ac": @"DXS9I1Jxjwyw8JOndEeK",
        @"br": @"master",
        @"en": @"dev",
        @"ev": eventId,
        @"ha": hash,
...
+ (void)invokeMeta:(NSString *)type messages:(NSArray *)messages {
  if (samplingRate > 0) {
    if (drand48() < samplingRate) {
      NSLog(@"invokeMeta DXS9I1Jxjwyw8JOndEeK master 0cd8DLUxoxnhXaqRxL6O DQ9ku0SjZ");
      NSDictionary *payload = @{
        @"ac": @"DXS9I1Jxjwyw8JOndEeK",
        @"br": @"master",
        @"en": @"dev",
