...
+ (void)invoke:(NSString *)eventId hash:(NSString *)hash messages:(NSArray *)messages {
  ...
  if (samplingRate > 0) {
    if (drand48() < samplingRate) {
      NSLog(@"invoke O5vBH9u50KQ0FB9kqcMj master 0cd8DLUxoxnhXaqRxL6O DQ9ku0SjZ");
      NSDictionary *payload = @{
        @"ac": @"O5vBH9u50KQ0FB9kqcMj",
        @"br": @"master",
        @"en": @"dev",
        @"ev": eventId,
        @"ha": hash,
...
+ (void)invokeMeta:(NSString *)type messages:(NSArray *)messages {
  if (samplingRate > 0) {
    if (drand48() < samplingRate) {
      NSLog(@"invokeMeta O5vBH9u50KQ0FB9kqcMj master 0cd8DLUxoxnhXaqRxL6O DQ9ku0SjZ");
      NSDictionary *payload = @{
        @"ac": @"O5vBH9u50KQ0FB9kqcMj",
        @"br": @"master",
        @"en": @"dev",
