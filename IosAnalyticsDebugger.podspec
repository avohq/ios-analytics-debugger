...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of IosAnalyticsDebugger.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Alexey Verein/IosAnalyticsDebugger'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Alexey Verein' => 'tpom6oh@gmail.com' }
  s.source           = { :git => 'https://github.com/Alexey Verein/IosAnalyticsDebugger.git', :tag => s.version.to_s }
